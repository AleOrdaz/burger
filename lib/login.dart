...
import 'package:untitled/utils/singleton.dart';
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
              //top: size.height * 0.45, //Comentar esta linea ya que el
              // widget Column puede posicionar su contenido
              left: size.width * 0.05,
              right: size.width * 0.05,
              bottom: size.height * 0.08 //Agregamos esta paddin inferior
            ),
            child: Column(
              //Con estas dos lineas de código lograremos ajustar el formulario
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            if (user.text == 'alexia' && password.text == '123456') {
                              //almacenamos los datos en Singleton
                              singleton.user = user.text;
                              singleton.password = password.text;
                              //almacenamos los datos en Preferencias del usuario
